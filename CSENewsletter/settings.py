"""
Django settings for CSENewsletter project.
...
SECRET_KEY = 'django-insecure-+w%yhn*erqbd&vlwyew5lc1ansfjfi9-l&h#=rukdt!)c%bmk4'
...
ALLOWED_HOSTS = [
    ...
    "cse-newsletter-backend.onrender.com",
]
